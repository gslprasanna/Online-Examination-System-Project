...
?>
        ...
        <div class="row" style="margin: 0px; padding:0px; margin-bottom: 30px;">
            ...
            <div class="col-lg-6 col-lg-push-3" style="min-height: 600px; background-color:#E0D1DB;">
 <center>
            <h1 style="color:black;padding-top:50px;padding-bottom:40px"> Quiz Results</h1></center>
               <?php
                 $correct=0;
                 $wrong=0;
      ...
      $res=mysqli_query($conn,"select * from questions where category='$_SESSION[exam_category]'");
       ...
       echo "<br>";echo "<br>";
           ...
           echo "<tr style='background-color:#2952a3; color:white'>";
